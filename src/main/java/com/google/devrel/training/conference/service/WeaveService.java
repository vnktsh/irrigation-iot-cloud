...
public class WeaveService {
  ...
  private static final String APP_USER_ID = "petrichor";
  private static final String CLIENT_ID = "93613857662-df07pmbjhh0tou0o4i3g9ljecl8s8ie7.apps.googleusercontent.com";
  private static final String CLIENT_SECRET = "IEvtUEmH3YS5G92f8HfGevlR";
  ...
  public String run() {
    ...
    if (devices == null || devices.isEmpty()) {
      ...
      return "no devices found";
  		...
  		int i =0;
      String moisture_device_id = "af1fcb21-101e-5eca-23b3-3401cd4da57e";
      ...
      try {
        ...
        Map<String, Object> stateMap = (Map) stateVarMap.get("_moisturedevice");
        return (String) stateMap.get("_moisture_reading");
  ...
  private void sendCommand(String cmd, CloudDevices apiClient, String device_id) {
      ...
      Command command = new Command()
          .setName("_moisturedevice._set")  // Command name to execute.
